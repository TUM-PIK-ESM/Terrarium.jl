...
# do nothing for now
@inline compute_auxiliary!(idx, state, model::AbstractSoilModel, strat::HomogeneousSoil) = nothing

@inline compute_tendencies!(idx, state, model::AbstractSoilModel, strat::HomogeneousSoil) = nothing
