...
function compute_auxiliary!(state, vegcarbon_dynamics::PALADYNCarbonDynamics)
    grid = get_grid(vegcarbon_dynamics)
...
function compute_tendencies!(state, vegcarbon_dynamics::PALADYNCarbonDynamics)
    grid = get_grid(vegcarbon_dynamics)
