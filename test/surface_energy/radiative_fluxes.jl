...
@testset "Diagnosed radiative fluxes" begin
    ...
    T_skin_K = Terrarium.celsius_to_kelvin(model.constants.thermodynamics, 0.0)
    @test all(state.surface_longwave_up .≈ (1 - 0.9) * surface_longwave_down + Terrarium.stefan_boltzmann(model.constants.universal, T_skin_K, 0.9))
