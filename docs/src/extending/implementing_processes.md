...
II. **Kernel functions**; this includes both the `@kernel` entry point and subsequently inlined functions with signatures of the form `compute_*(i,j[,k], grid, fields, ::Process, args...)`
