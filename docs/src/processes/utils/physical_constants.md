...
| `latent_heat_vaporization_at_reference` | $L_{lv}$ | 2.257×10⁶ | J/kg | Specific latent heat of vaporization at 0°C |
| `latent_heat_sublimation_at_reference` | $L_{sg}$ | 2.834×10⁶ | J/kg | Specific latent heat of sublimation at 0°C |
